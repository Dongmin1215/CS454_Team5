...
if __name__ == '__main__':
    ...
    parser.add_argument("-n", "--number", help="number of test suites to compute over", type=int, default=100)
    parser.add_argument("-e", "--embedding", help="type of embedding used (1 for non-distortive, 2 for distortive)",
                        type=int)
    parser.add_argument("-init", "--initial", help="initial number of candidates", type=int, default=2 ** 5)

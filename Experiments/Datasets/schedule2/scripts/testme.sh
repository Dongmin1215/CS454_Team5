...
#  /testplans.alt/testplans-bigcov/s815" "-sn" "testme.sh" "-tg" "sir.mts.genera
#  tors.BourneShellScriptGenerator"

echo ">>>>>>>>running test 1"
./schedule2 8 9 0 < input/inp.37  > ../outputs/t1
gcov schedule2.c
mv schedule2.c.gcov ../traces/dump_000001
rm *.gcda

echo ">>>>>>>>running test 2"
./schedule2 7 10 4 < input/inp.10  > ../outputs/t2
gcov schedule2.c
mv schedule2.c.gcov ../traces/dump_000002
rm *.gcda

echo ">>>>>>>>running test 3"
./schedule2 2 8 0 < input/inp.55  > ../outputs/t3
gcov schedule2.c
mv schedule2.c.gcov ../traces/dump_000003
rm *.gcda

echo ">>>>>>>>running test 4"
./schedule2 6 2 3 < input/inp.2  > ../outputs/t4
gcov schedule2.c
...
./schedule2 1 0 0 < input/zt.25  > ../outputs/t234
gcov schedule2.c
mv schedule2.c.gcov ../traces/dump_000234
rm *.gcda

echo ">>>>>>>>running test 235"
./schedule2 2 3 -1 < input/zt.4  > ../outputs/t235
gcov schedule2.c

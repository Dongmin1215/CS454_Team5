...
# MakeTestScript (modified by Shin) on Dec 13, 2020 at 6:58:37 AM
# by the command: 
#  java sir.mts.MakeTestScript "-en" "./print_tokens2" "-gc" "print_tokens2.c" "
#  -sf" "../testplans.alt/testplans-bigcov/s50" "-sn" "testme.sh" "-tg" "sir.mts
...
gcov print_tokens2.c
mv print_tokens2.c.gcov ../traces/dump_000394
rm *.gcda

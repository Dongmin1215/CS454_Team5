...
# MakeTestScript (modified by Shin) on Dec 14, 2020 at 8:30:07 AM
# by the command: 
#  java sir.mts.MakeTestScript "-en" "./schedule" "-gc" "schedule.c" "-sf" "../t
#  estplans.alt/testplans-bigcov/s738" "-sn" "testme.sh" "-tg" "sir.mts.generato
#  rs.BourneShellScriptGenerator"

echo ">>>>>>>>running test 1"
./schedule 5 8 7 < input/inp.6  > ../outputs/t1
gcov schedule.c
mv schedule.c.gcov ../traces/dump_000001
rm *.gcda

echo ">>>>>>>>running test 2"
./schedule 0 4 1 < input/inp.75  > ../outputs/t2
gcov schedule.c
mv schedule.c.gcov ../traces/dump_000002
rm *.gcda

echo ">>>>>>>>running test 3"
./schedule 1 2 7 < input/inp.30  > ../outputs/t3
gcov schedule.c
mv schedule.c.gcov ../traces/dump_000003
rm *.gcda

echo ">>>>>>>>running test 4"
./schedule 9 4 2 < input/inp.15  > ../outputs/t4
gcov schedule.c
...
echo ">>>>>>>>running test 6"
./schedule 10 4 5 < input/inp.53  > ../outputs/t6
gcov schedule.c
mv schedule.c.gcov ../traces/dump_000006
rm *.gcda

echo ">>>>>>>>running test 7"
./schedule 1 10 6 < input/inp.1  > ../outputs/t7
gcov schedule.c
mv schedule.c.gcov ../traces/dump_000007
rm *.gcda

echo ">>>>>>>>running test 8"
./schedule 0 6 8 < input/inp.90  > ../outputs/t8
gcov schedule.c
...
./schedule 1 2 1 < input/et.6  > ../outputs/t215
gcov schedule.c

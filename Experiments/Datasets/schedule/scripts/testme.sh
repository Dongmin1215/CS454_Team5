...
# MakeTestScript (modified by Shin) on Dec 13, 2020 at 7:43:34 AM
# by the command: 
...
./schedule 5 0 2 < ../input/dat458  > ../outputs/t85
gcov schedule.c
mv schedule.c.gcov ../traces/dump_000085
rm *.gcda

echo ">>>>>>>>running test 86"
./schedule 2 0 2 < ../input/dat482  > ../outputs/t86
gcov schedule.c
mv schedule.c.gcov ../traces/dump_000086
rm *.gcda

echo ">>>>>>>>running test 87"
./schedule 0 3 5 < ../input/dat485  > ../outputs/t87
gcov schedule.c

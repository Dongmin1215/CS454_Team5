...
# MakeTestScript (modified by Shin) on Dec 14, 2020 at 3:53:32 PM
# by the command: 
#  java sir.mts.MakeTestScript "-en" "./schedule" "-gc" "schedule.c" "-sf" "../t
#  estplans.alt/testplans-bigcov/s358" "-sn" "testme.sh" "-tg" "sir.mts.generato
...
./schedule 1 4 3 < input/dat436  > ../outputs/t80
gcov schedule.c
